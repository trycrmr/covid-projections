...
const SHORT_DESCRIPTION_HIGH = 'Indicates far too little testing';
const SHORT_DESCRIPTION_UNKNOWN = 'Insufficient data to assess';

const LIMIT_LOW = 0.03;
const LIMIT_MEDIUM = 0.05;
const LIMIT_MEDIUM_HIGH = 0.1;
...
export function positiveTestsStatusText(projection: Projection) {
  ...
  const testingBroadlyText = levelText(
    ...
    `which indicates that testing in ${location} is limited and that many cases may go undetected`,
