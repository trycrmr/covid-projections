...
export function contactTracingStatusText(projection: Projection) {
  ...
  const outcomesAtLevel = levelText(
    level,
    `These low levels of tracing suggest there may be an active outbreak underway in ${location}, or almost no tracing capacity exists. Strong caution is warranted.`,
    `These low levels of tracing suggest there may be an active outbreak underway in ${location}, or that little tracing capacity exists. Strong caution is warranted.`,
